...
- Welcome dialog offers blank start or run-with-library template
...
- Group Signals / Select Best Group nodes split batches and continue with the highest-quality group
...
- Save/Open actions serialize graphs to JSON for reuse
- Built-in template mirrors run_with_library.py for quick starts
